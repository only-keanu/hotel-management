...
interface WeeklyCalendarProps {
  ...
  bookings: Booking[];
  guests: Guest[];
  onAddBooking: (roomId: string | number, date: Date) => void;
...
const WeeklyCalendar: React.FC<WeeklyCalendarProps> = ({
  ...
  const roomsWithBookings = rooms.filter(room =>
      weekBookings.some(booking => booking.roomId === room.id)
  );
  ...
  const handleCellClick = (booking: Booking | null, room: Room, day: Date) => {
                  ...
                  <Fragment key={room.id}>
                    ...
                    {daysInWeek.map((day, i) => {
                      ...
                      return (
                          <div
                              key={i}
                              className={`bg-white border-b border-gray-200 p-1 min-h-[60px] ${
                                  isToday ? 'bg-blue-50' : ''
                              }`}
                          >
                            {bookingsForDay.length > 0 ? (
                                bookingsForDay.map(booking => {
                                  ...
                                  return (
                                      <div
                                          ...
                                          onClick={() => handleCellClick(booking, room, day)}
                                      >
                                ...
                                <div className="h-full w-full flex items-center justify-center">
                                  <button
                                      ...
                                      onClick={() => handleCellClick(null, room, day)}
                                  >
