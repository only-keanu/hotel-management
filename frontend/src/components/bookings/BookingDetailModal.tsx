...
import { CalendarIcon, UserIcon, HomeIcon, CreditCardIcon } from 'lucide-react';
...
interface BookingDetailModalProps {
  ...
  room: Room | null;
  guest: Guest | null;
  onCheckIn: (bookingId: number | string) => void;
  onCheckOut: (bookingId: number | string) => void;
  ...
  return (
      <>
            ...
            footer={
              <>
                ...
                {booking.status === 'checked_in' && (
                    <>
                      <button
                          onClick={() => onShowChecklist(booking)}
        ...
        <ConfirmationModal
            ...
            message={`Are you sure you want to check in ${guest.firstName} ${guest.lastName} to Room ${room.number}?`}
        ...
        <ConfirmationModal
            ...
            message={`Are you sure you want to check out ${guest.firstName} ${guest.lastName} from Room ${room.number}?`}
