...
const BookingCard: React.FC<BookingCardProps> = ({
  ...
  return <Card className="overflow-hidden">
      <div className="p-4">
        ...
        {booking.notes && <div className="border-t border-gray-100 pt-2 mt-2">
      ...
      <div className="bg-gray-50 px-4 py-3 flex justify-between">
        ...
        {booking.status === 'confirmed' && <button className="text-sm bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded">
            Check In
          </button>}
        {booking.status === 'checked_in' && <button className="text-sm bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded">
            Check Out
          </button>}
      </div>
    </Card>;
